...
#include "../../producerConsumerPattern/src/ui/actionwidget.h"
...
QT_MOC_LITERAL(3, 19, 10), // "buttonBack"
QT_MOC_LITERAL(4, 30, 6) // "Update"

    },
    "ActionWidget\0back\0\0buttonBack\0Update"
};
...
void ActionWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ActionWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ActionWidget::back)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ActionWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ActionWidget.data,
      qt_meta_data_ActionWidget,  qt_static_metacall, nullptr, nullptr}
};
